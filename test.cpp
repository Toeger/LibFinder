...
static void test_reading_arguments() {
	...
	std::pair<std::vector<string_view>, Argument_parser::Argument_type> inputs[] ={
		{{}, Argument_parser::Argument_type::invalid},
		{{short_help}, Argument_parser::Argument_type::help},
		{{long_help}, Argument_parser::Argument_type::help},
		{{short_update}, Argument_parser::Argument_type::update},
		{{long_update}, Argument_parser::Argument_type::update},
	};
	for (auto &input : inputs){
		assert_equal(Argument_parser::get_argument_type(input.first), input.second);
	}
}
